...
(async () => {
  ...
  await fs.writeFile("hypertrophy-of-nasal-turbinates-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hypertrophy-of-nasal-turbinates-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
